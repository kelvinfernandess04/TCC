...
def main():
    ...
    ret_code_1 = os.system(f'python "{os.path.join(script_dir, "dataset_extractor.py")}"')
    if ret_code_1 != 0:
    ...
    ret_code_2 = os.system(f'python "{os.path.join(script_dir, "neural_engine.py")}"')
    if ret_code_2 != 0:
    ...
    os.system(f'python "{os.path.join(script_dir, "update_poc.py")}"')
